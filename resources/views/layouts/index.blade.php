...
<body {{ Route::currentRouteName() == 'show-edit-manage' ? 'class="hold-transition sidebar-mini" id=dangtintuc' : '' }}>
    ...
    <script src="https://batdongsan.vn/js/news/app.js"></script>

    <script src="https://batdongsan.vn/js/news/sticky.js"></script>
    <script src="https://batdongsan.vn/js/news/custom.js"></script>
